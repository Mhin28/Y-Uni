// Final local storage for complete balance data
...
part 'tmp_rovodev_final_storage.g.dart';

@riverpod
CompleteLocalStorage completeLocalStorage(CompleteLocalStorageRef ref) {
  return CompleteLocalStorage();
}

class CompleteLocalStorage {
  static const String _completeBalanceDataKey = 'complete_balance_data_';
  ...
  Future<void> saveCompleteBalanceData(CompleteBalanceData balanceData) async {
    final prefs = await SharedPreferences.getInstance();
    final key = '$_completeBalanceDataKey${balanceData.userId}';
  ...
  Future<CompleteBalanceData?> getCompleteBalanceData(String userId) async {
    final prefs = await SharedPreferences.getInstance();
    final key = '$_completeBalanceDataKey$userId';
    ...
    try {
      ...
      return CompleteBalanceData.fromJson(json);
    } catch (e) {
  ...
  Future<void> savePendingExpense(CreateExpenseRequest expense, String userId) async {
    final prefs = await SharedPreferences.getInstance();
  ...
  Future<void> savePendingBudget(CreateBudgetRequest budget, String userId) async {
    final prefs = await SharedPreferences.getInstance();
  ...
  Future<void> clearAllCache() async {
    ...
    for (final key in keys) {
      if (key.startsWith(_completeBalanceDataKey) ||
